...
return [
    ...
    'logo' => 'https://bulk-text-service.co.uk/uploads/branding/Bulk-Text-Service/logo/8BwlKxw7QpBpcTPK5nmcLNuk6KrqjWwlK2OjGlYx.png',
    ...
    'title' => 'Bulk Text Service Api Doc API Reference',

    'description' => 'All actions within our API service require a pre authorised access token, this can be generated from within your portal.',
    ...
    'servers' => [
        [
            'url' => 'https://app.bulk-text-service.co.uk/',
            'description' => 'API SMS Server.',
        ],
        [
            'url' => 'https://app.microsite.website/',
            'description' => 'Documentation test server.',
        ],
